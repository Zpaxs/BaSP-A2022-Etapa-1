...
var musicGenres = ["rock", "metal", "pop", "grunge", "rap"];
for (i = 0; i < musicGenres.length; i++) {
  var musicGenre = musicGenres[i];
  alert("Music genre: " + musicGenre);
}
...
for (i = 0; i < musicGenres.length; i++) {
  var musicGenre = musicGenres[i];
  var musicGenresUppercase = musicGenre.substring(1, 0).toUpperCase() + musicGenre.substring(1);
  alert("Music genres with uppercase: " + musicGenresUppercase);
  console.log(musicGenresUppercase);
}
...
for (i = 0; i < musicGenres.length; i++) {
  var musicGenre = musicGenres[i];
  sentence = sentence + " " + musicGenre;
}
alert(sentence);
console.log((sentence = sentence + " " + musicGenre));
